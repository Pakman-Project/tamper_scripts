...
(function () {
  ...
  // native clicks — rows must be clicked through the page's own jQuery. Every
  // layout-dependent lookup goes through these helpers.
  //
  ...
  // path test mis-classifies it as legacy. #progress-overview-grid ships in the
